  {!! Form::open(['data-remote', 'route' => 'ajaxFormSubmit']) !!}
		...
		<div class="row">
			<div class="input-field s12 col">
				{!! Form::label('contact-message', 'Question:') !!}
		...
		<div class="row">
			<div class="input-field s12 col contact__submit">
				{!! Form::submit('Send Your Question', ['class'=>'btn waves-effect waves-green']) !!}
			</div>
		...
		<div class="contact__message" 
			 data-success-message="Thanks for your interest in McDaniel Nutrition Therapy.  We will review your question and answer you withing 2-3 business days."
