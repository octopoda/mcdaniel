<section class="navigation" id="navigationWrapper">
	...
	<nav class="col s12 m8 navigation__menu" id="mainMenu">
		<ul>
			<li>
				<a  data-beloworigin="true" data-hover="true" data-constrainswidth="false" data-activates="individualDropdown" href="#" class="dropdown-button">Individuals</a>
			...
			<li>
				<a  data-beloworigin="true" data-hover="true" data-constrainswidth="false" data-activates="corporateDropdown" href="#" class="dropdown-button">Corporate Wellness</a>
			...
			<li>
				<a   data-beloworigin="true" data-hover="true" data-constrainswidth="false" data-activates='mediaDropdown' class="dropdown-button" href="#">Media</a>
			...
			<li>
				<a href="#" class="dropdown-button" data-activates="aboutDropdown">About Us</a>
