...
class Post extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['title', 'content', 'searchable', 'summary', 'publish_date', 'published', 'post_image', 'post_thumbnail', 'post_facebook', 'video', 'video_url', 'blog_id', 'direct_link', 'post_type', 'tiny_url'];
